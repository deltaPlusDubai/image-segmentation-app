...
(function () {
  ...
  loadPackage({
    files: [
      ...
      {
        filename:
          "/third_party/mediapipe/modules/palm_detection/palm_detection.tflite",
        start: 2961104,
        end: 6838992,
        audio: 0,
      },
      ...
      {
        filename:
          "/third_party/mediapipe/modules/hand_landmark/hand_landmark.tflite",
        start: 6962795,
        end: 9034139,
        audio: 0,
      },
    ...
    remote_package_size: 10524443,
    package_uuid: "772325c6-110a-4594-8d42-8fb9e186d117",
  });
})();
